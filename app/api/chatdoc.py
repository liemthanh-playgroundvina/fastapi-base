...
from app.schemas.chatdoc import ChatDocLCRequest, EmbedDocRequest
...
def chat_doc_lc(
    ...
    Note:
        ...
        - We currently support pdf|doc|docx|txt|xls|xlsx|csv|ppt|pptx|md|html|xml and web

        - Limit: 128k token for document
    """
    try:
        # Handler file
        types = [
        ...
        return ChatDocService().chat_doc_lc(request, web_urls, files_path)
